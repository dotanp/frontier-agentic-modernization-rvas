...
[infrastructure guide](Student/Resources/java/infra/README.md) on GitHub, while
the general-prerequisites link should return to the site's prerequisites section.
Known challenge and solution links open in the drawer; other Markdown documents
