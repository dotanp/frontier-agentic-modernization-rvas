...
import { resolveDocumentLink } from '../web/assets/js/document-links.mjs';
...
const documents = ['README.md', 'Student/java/Challenge-00.md', 'Student/java/Challenge-01.md', 'Coach/java/Solution-00.md'];
const resolve = (href, source = 'Student/java/Challenge-00.md', page = pageUrl) =>
    resolveDocumentLink(href, source, page, documents);

test('the actual PhotoAlbum deployment link opens the infrastructure README, not the generic README', () => {
